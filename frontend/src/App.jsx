    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 px-4 py-8 font-sans text-gray-900">
            <div className="flex justify-between items-center mb-7">
                <div>
                    <div className="text-2xl font-semibold tracking-tight text-gray-900">License Plates</div>
                    <div className="text-xs text-gray-400 mt-1">Live list from backend</div>
                </div>
                <button
                ...
                <table className="min-w-full text-sm text-left">
                    <thead className="bg-gradient-to-b from-slate-50 to-slate-100/80">
                        <tr>
                            ...
                            <th className="py-4 px-2 font-medium text-gray-500">Detected Date</th>
                        ...
                        {items.length === 0 && !loading ? (
                            <tr>
                                <td colSpan={3} className="text-center text-gray-400 py-8">
                                    No plates found. Click Refresh to try again.
                                </td>
                            </tr>
                        ) : (
                            items.map((it, idx) => (
